...
- 使用 [**hackathon** 目录](../hackathon/README.md) 中的 **DreamBooth** 笔记本微调自己的 SD 模型并分享（黑客松已结束，仍可学习与实践）。
...
![Stable Diffusion 生成示例](../images/unit3/sd_demo_images.jpg)  
...
![潜空间扩散示意图](../images/unit3/latent_diffusion_diagram.png)  
...
![文本编码流程](../images/unit3/text_encoder.png)  
...
![UNet 中的条件注入](../images/unit3/unet.png)
...
![不同 CFG 尺度](../images/unit3/cfg_example.jpeg)  
...
![DreamBooth 示意图](../images/hackathon/dreambooth_teaser.jpg)  
_图片来自 [DreamBooth 项目页](https://dreambooth.github.io/)（基于 Imagen）_

**DreamBooth** 用于微调文生图模型以学习新概念（特定物体或风格），最初针对 Imagen，很快适配 [Stable Diffusion](https://huggingface.co/docs/diffusers/training/dreambooth)。效果可非常出色（许多 AI 头像即由此类服务产生），但对超参敏感；请参阅 [hackathon 笔记本](../hackathon/dreambooth.ipynb) 与 [HF 博客调查](https://huggingface.co/blog/dreambooth)。

## 动手笔记本

| 章节 | 本地笔记本 |
|:-----|:-----------|
| Stable Diffusion 入门 | [stable_diffusion_introduction.ipynb](stable_diffusion_introduction.ipynb) |
| DreamBooth 黑客松 | [../hackathon/dreambooth.ipynb](../hackathon/dreambooth.ipynb) |
...
可跟随 **DreamBooth** 笔记本在指定主题上训练模型；黑客松已结束，仍可练习并上传到 Hub。详情见 [hackathon/README.md](../hackathon/README.md)。
