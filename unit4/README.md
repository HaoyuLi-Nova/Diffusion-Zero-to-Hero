...
![渐进蒸馏示意图](../images/unit4/progressive_distillation.png)
...
![ERNIE-ViLG 2.0 论文图 2](../images/unit4/ernie_vilg_mode.png)  
...
![eDiffi「用文字作画」示例](../images/unit4/ediffi_paint_with_words.png)  
...
1. **加噪后用新提示去噪** — `img2img` 管道的核心，并有多种扩展：  
   ...
   - **DDIM 反演**：沿采样轨迹「反向」而非随机加噪，控制更精细 — 见本仓库 [01_ddim_inversion.ipynb](01_ddim_inversion.ipynb)  
...
![Imagen Video 示例帧](../images/unit4/imagen_video_frames.png)  
...
![Riffusion 频谱图](../images/unit4/riffusion_spectrogram.png)  
...
![Cold Diffusion 论文图 1](../images/unit4/cold_diffusion.png)  
...
![MaskGIT 流程](../images/unit4/maskgit_pipeline.png)  
...
| 章节 | 本地笔记本 |
|:-----|:-----------|
| DDIM 反演 | [01_ddim_inversion.ipynb](01_ddim_inversion.ipynb) |
| 音频扩散 | [02_diffusion_for_audio.ipynb](02_diffusion_for_audio.ipynb) |
...
从研究角度，建议继续关注 **DiT**、**Flow Matching**、**Rectified Flow** 与多模态视频模型。它们与本单元的「迭代精炼」思想一脉相承，但在架构和训练目标上更接近 2024 年之后的主流路线。更完整的后续路线见 [docs/modern-diffusion-roadmap.md](../docs/modern-diffusion-roadmap.md)。
