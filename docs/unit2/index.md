...
![在 LSUN Bedrooms 上训练、在 WikiArt 上微调 500 步后的生成示例](https://raw.githubusercontent.com/HaoyuLi-Nova/Diffusion-Zero-to-Hero/master/images/unit2/finetune_sample_generations.png)
...
![引导示例](https://raw.githubusercontent.com/HaoyuLi-Nova/Diffusion-Zero-to-Hero/master/images/unit3/cfg_example.jpeg)
...
![条件生成示例](https://raw.githubusercontent.com/HaoyuLi-Nova/Diffusion-Zero-to-Hero/master/images/unit3/sd_demo_images.jpg)
...
| 章节 | 本地笔记本 |
|:-----|:-----------|
| 微调与引导 | [01-finetuning-and-guidance.md](01-finetuning-and-guidance.md) |
| 类别条件扩散模型示例 | [02-class-conditioned-diffusion-model.md](02-class-conditioned-diffusion-model.md) |
